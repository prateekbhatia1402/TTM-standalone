...
public class SqlConnect {
    ...
    private static final String DATABASE_NAME = "TTMPRATEEKv3";
    public static final String UNKNOWN_DATABASE_ERROR_MESSAGE = "unknown database 'ttmprateekv3'";
    ...
    public static void fillDummyData() {
        try (Connection c = SqlConnect.getDatabaseConnection()) {
            ...
            ParentDetails parent = ParentDetails.createParentDetails("P000000001",
                    "raj", "raj@gmail.com", "9915123456", new Date(1996, 02, 03), "rani",
                    "rani@gmail.com", "9988776655", new Date(1968, 02, 03), "2000000-50000000", null);
            Student student = Student.createStudent("S00001", "dev", "devgarg", "devgarg@gmail.com",
                    "9988765432", "model town@delhi@delhi@india@110023",
                    "model town@delhi@delhi@india@110023", 1,
                    new Date(2000, 02, 03), new Date(2020, 02, 17), 'M', "B+", parent.getParentId(), "C00001");
   ...
   student.setParentId(parent.getParentId());
            ...
            parent = ParentDetails.createParentDetails("P000000004", "raja", "raja1@gmail.com", "9915123110", new Date(1991, 10, 03), "LOLI",
                    "LOLI@gmail.com", "9982376565", new Date(1961, 12, 23),
                    "1000000-20000000", student);
   student.setParentId(parent.getParentId());
            account = Account.createAccount(student.getUsername(), "123456", "student");
            StudentRegBackend.addStudentToRecords(student, parent, account, 6969);
...
CREATE TABLE `subject` (
    ...
    PRIMARY KEY (`SUBJECT ID`)
            ...
            */
            st.executeUpdate("insert into subject"
                    + "(`SUBJECT ID`, `SUBJECT NAME`, `LECTURES REQUIRED`) "
                    + "values('ENG_06','ENGLISH',4)");
            st.executeUpdate("insert into subject"
                    + "(`SUBJECT ID`, `SUBJECT NAME`, `LECTURES REQUIRED`)"
                    + " values('HIN_06','HINDI',4)");
            st.executeUpdate("insert into subject(`SUBJECT ID`, `SUBJECT NAME`, `LECTURES REQUIRED`) values('MAT_06','MATHS',4)");
            st.executeUpdate("insert into subject(`SUBJECT ID`, `SUBJECT NAME`, `LECTURES REQUIRED`) values('SST_06','SOCIAL SCIENCE',4)");
            st.executeUpdate("insert into subject(`SUBJECT ID`, `SUBJECT NAME`, `LECTURES REQUIRED`) values('SCI_06','SCIENCE',4)");
            st.executeUpdate("insert into subject(`SUBJECT ID`, `SUBJECT NAME`, `LECTURES REQUIRED`) values('PUN_06','PUNJABI',2)");
            st.executeUpdate("insert into subject(`SUBJECT ID`, `SUBJECT NAME`, `LECTURES REQUIRED`) values('COM_06','COMPUTER',2)");
            st.executeUpdate("insert into subject(`SUBJECT ID`, `SUBJECT NAME`, `LECTURES REQUIRED`) values('G.K_06','G.K.',1)");
